...
import com.kfouri.controlatusgastos.Activities.NuevoListadoActivity;
...
/**
 * Created by mkfouri on 18/11/2015.
 */
public class GastoMensualCustomAdapter extends ArrayAdapter<Gasto>
{
    ...
    public GastoMensualCustomAdapter(Context context, int layoutResourceId, ArrayList<Gasto> data) {
